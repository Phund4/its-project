...
|-----------|-------------------------------|----------------|
| **Data Ingestion** | Сообщения приняты, нормализованы и попали в Kafka с приемлемой задержкой | Метрики: принятые/отклонённые события, задержка end-to-end до брокера, ошибки по типам; синтетические **worker status**-источники или контрольные файлы в тестовом контуре |
