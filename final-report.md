...
**Тема**: Финальная интеграция ML-сервиса: инференс, связка компонентов, мониторинг, контейнеризация

**ФИО**: Попов Александр Иванович  
**Группа**: БВТ2203

Проект **PIIS** — распределённая ИТС: приём видео и телеметрии, ML-инференс, аналитика в ClickHouse, карта, мониторинг.
...
Выбор финальной модели после ЛР3:
